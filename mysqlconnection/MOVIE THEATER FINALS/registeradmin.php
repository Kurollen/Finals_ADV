        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menu">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="index.php">Now Showing</a>
                    </li>
        ...
        <div class="bg-light p-5">
            ...
            <form action="" method="post">
                ...
                <h4 class="mb-4 fs-5 text-dark text-center">
                    Please fill in the Details of Admin
                </h4>

                <h4 class="mb-4 fs-6 text-secondary text-center">
                    These details are for the Admin.
                </h4>
...
if (isset($_POST["reg"])) {
    ...
    VALUES ('$fullname', 'admin', '$email', '$username', '$password', '$otp', 'Pending')";
    ...
    if ($result == true){
        ...
        window.location.href = "otpchecker.php"; 
        });
    </script>
    <?php
    } else {
