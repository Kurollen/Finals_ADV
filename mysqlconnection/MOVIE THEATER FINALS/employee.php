    ...
    if (isset($_POST['btnsearch']) && $search !== '') {
        $displaysql = "SELECT * FROM movie WHERE title LIKE '%$search%' OR genre LIKE '%$search%'";
    } else {
    ...
    <head>
        ...
        <title>Employee | View Movies</title>
    ...
    <section class="py-4 bg-white flex-grow-1">
        <div class="container">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                <form method="post" action="adminview.php" class="d-flex gap-2">
                    <input type="search" name="searchinput" class="form-control"
                        placeholder="Search movies..."
                        value="<?= htmlspecialchars($_POST['searchinput'] ?? '') ?>"
                        style="width:220px;">
                    <button type="submit" name="btnsearch" class="btn btn-dark">Search</button>
                </form>
                <a href="adminadd.php" class="btn btn-warning fw-bold">+ Add Movie</a>
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-center gap-4">
                ...
                <div class="card">
                    ...
                    <div class="card-actions">
                        <a href="adminview.php?id=<?= $movie['movie_id'] ?>" class="btn btn-outline-secondary btn-sm">View</a>
                        <a href="adminedit.php?id=<?= $movie['movie_id'] ?>" class="btn btn-outline-warning btn-sm">Edit</a>
    ...
    <footer class="bg-dark text-white text-center py-3">
        <p class="mb-0">© Finals Movie Booking System — Employee Panel</p>
    </footer>
