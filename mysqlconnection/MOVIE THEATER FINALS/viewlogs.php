...
<body>
    ...
    <section class="bg-warning text-center p-3 shadow-lg">
        <div class="container py-3">
            <h1 class="display-5 fw-bold">System Logs</h1>
            <p class="fw-semibold mt-2 mb-0">Track and review all logs by users.</p>
        </div>
    </section>
    ...
    <section class="py-4 bg-white flex-grow-1">
        <div class="container">
            ...
            <div class="mb-3">
                <a href="adminview.php" class="text-dark fw-semibold text-decoration-none">← Back to Admin Dashboard</a>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-dark table-striped table-hover m-0 align-middle">
                        <thead class="table-secondary text-uppercase fs-7">
                            <tr>
                                <th class="ps-4 py-3">Log_id</th>
                                <th class="py-3">User_id</th>
...
<?php
    ...
    foreach ($result as $fieldname) {
        echo "<tr>";
        echo "<td class='ps-4 fw-semibold text-warning'>".$fieldname['log_id']."</td>";
        echo "<td><span class='badge bg-secondary'>".$fieldname['user_id']."</span></td>";
        echo "<td>".$fieldname['action']."</td>";
        echo "<td class='pe-4 text-end text-light-50 fs-7'>".$fieldname['datetime']."</td>";
        echo "</tr>";
    }
}
else {
